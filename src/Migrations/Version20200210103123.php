 ...
 */
final class Version20200210103123 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE event CHANGE id_user id_user_Event INT DEFAULT NULL');
        $this->addSql('ALTER TABLE event ADD CONSTRAINT FK_3BAE0AA7BD275E2C FOREIGN KEY (id_user_Event) REFERENCES user_event (id)');
        $this->addSql('CREATE INDEX IDX_3BAE0AA7BD275E2C ON event (id_user_Event)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE event DROP FOREIGN KEY FK_3BAE0AA7BD275E2C');
        $this->addSql('DROP INDEX IDX_3BAE0AA7BD275E2C ON event');
        $this->addSql('ALTER TABLE event CHANGE id_user_event id_user INT DEFAULT NULL');

 ...
 */
final class Version20191125102314 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE event (id_event INT AUTO_INCREMENT NOT NULL, id_category INT NOT NULL, id_user INT NOT NULL, location VARCHAR(30) NOT NULL, private_event TINYINT(1) NOT NULL, creation_date DATETIME NOT NULL, title VARCHAR(200) NOT NULL, description VARCHAR(1000) NOT NULL, start_date DATETIME NOT NULL, end_date DATETIME NOT NULL, INDEX IDX_3BAE0AA75697F554 (id_category), UNIQUE INDEX UNIQ_3BAE0AA76B3CA4B (id_user), PRIMARY KEY(id_event)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
